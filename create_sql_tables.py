...
def create_sql_tables(db_name):
    try:
        ...
        cursor.execute('create table cases(id integer primary key autoincrement, name varchar(50), status int, month_path text, create_time text, update_time text)')
...
def create_sql_web_tables(db_name):
    try:
        ...
        cursor.execute('create table users(id integer primary key autoincrement, name varchar(50), hashed_password varchar(100), salt varchar(100), is_admin bool)')
